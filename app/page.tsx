            ...
            <div className="bg-[#121212]/60 backdrop-blur-xl border border-white/5 rounded-xl p-6 space-y-4 shadow-xl">
              <div className="space-y-4">
                ...
                <div className="space-y-2 border-l-2 border-[#97144d] pl-4">
                  <p className="text-xs text-gray-400">Provide a detailed narrative, not just a list. Outline the variables:</p>
                  <ul className="text-[11px] text-gray-500 space-y-0.5">
                    <li>• <span className="text-gray-300 font-medium">Who:</span> Define the specific user role and their constraints.</li>
                    <li>• <span className="text-gray-300 font-medium">Where:</span> Describe the physical or digital environment.</li>
                    <li>• <span className="text-gray-300 font-medium">What:</span> Detail the exact point of friction or observed failure.</li>
                  </ul>
                </div>
              </div>
              ...
              <textarea 
                ...
                placeholder="Write your brief here. Example structure:&#10;&#10;An elderly user is sitting in a crowded, noisy bank lobby trying to renew a fixed deposit on their phone. The app keeps flashing confusing permission alerts, making them anxious. Because they don't trust the screen, they manually copy the login codes onto a paper notepad. While they are busy writing, the app runs out of time and completely locks them out."
                value={context}
